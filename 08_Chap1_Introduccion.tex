...
%En este contexto, se propone utilizar un umbral de detección que ignore píxeles con un sólo electrón, de forma de evitar un píxel con una carga originada en eventos de fondo se adicione a un cluster de interes, haciendo que este entre en contacto con un tercero, dando lugar al aglutinamiento de clusters de interes. La carga neta del nuevo cluster haría que el mismo deje de encontrarse entre los de interes. Por lo tanto, evitar este efecto debe redundar en un aumento de la estadística.
