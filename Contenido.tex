...
\begin{itemize}
    \item resultados anteriores donde se usó el skipper:
        \subitem Calibración absoluta del sensor entre 0 y 1900 electrones (relacion 1 a 1 entre cantidad de electrones y ADUS)
        \subitem Medicion absoluta del factor de Fano para 5.9keV a 123k
        \subitem Determinacion de la energia de creacion electrón hueco
\end{itemize}
