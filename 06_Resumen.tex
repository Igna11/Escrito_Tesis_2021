...
%\textcolor{red}{este parrafo necesita reformulacion. Si fuese por maximizar la estadística hubiésemos elegido EPIX 2.5. Lo de minimice el sesgo no me queda claro a que se refiere exactamente. Despues dice que se uso la informacion para corregir el sesgo, pero la info para eso fue otra, que sale de todo el analisis que hiciste en el capitulo 4. Asi pareciera que aplicar el corte te dio la info que necesitabas para corregir el sesgo.}
